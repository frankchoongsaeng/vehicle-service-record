...
INSERT INTO "new_vehicle_images" ("body_style", "classification_key", "color", "created_at", "generation_key", "id", "image_storage_key", "make", "model", "prompt_version", "trim", "updated_at", "vehicle_type", "view", "year_end", "year_start") SELECT "body_style", "classification_key", "color", "created_at", "generation_key", "id", "image_storage_key", "make", "model", "prompt_version", "trim", "updated_at", "vehicle_type", "view", "year_end", "year_start" FROM "vehicle_images";
