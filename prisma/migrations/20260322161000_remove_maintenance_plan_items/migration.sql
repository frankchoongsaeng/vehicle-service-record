-- DropIndex
DROP INDEX "maintenance_plan_items_maintenance_plan_id_idx";

-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "maintenance_plan_items";
...
INSERT INTO "new_service_records" ("cost", "created_at", "date", "description", "id", "maintenance_plan_id", "mileage", "notes", "service_type", "updated_at", "user_id", "vehicle_id") SELECT "cost", "created_at", "date", "description", "id", "maintenance_plan_id", "mileage", "notes", "service_type", "updated_at", "user_id", "vehicle_id" FROM "service_records";
